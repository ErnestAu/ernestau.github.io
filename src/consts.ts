...
export const EXPECT: { heading: string; paras: string[] }[] = [
  {
    ...
    paras: [
      ...
      'expect to be unwillingly led down tangents that have nothing to do with the title of the article.',
  ...
  },
  {
    ...
    paras: [
      ...
      `when i write, it REALLY exposes all my knowledge gaps. i'm forced to close the gaps so i can actually finish the article haha.`,
      ...
      `actually, right now as i'm writing this, i'm thinking that i might use this to write about stuff other than just learning, like personal thoughts or philosophy.`,
